...
function listuser(userArray) {
    ...
    for(var loop=0;loop<userArray.length;loop++) {
        ...
        outHTML += '<h2>All Users</h2>';
        outHTML += '<table>';
        outHTML += '<tr>';
        outHTML += '<th>Username:</th><tr>' + userArray[loop].USERNAME + '</tr>';
        outHTML += '<th>Full Name:</th><tr>' + userArray[loop].FULL_NAME + '</tr>';
        outHTML += '<th>Email:</th><tr>' + userArray[loop].EMAIL + '</tr>';
        outHTML += '<th>Gender:</th><tr>' + userArray[loop].GENDER + '</tr>';
